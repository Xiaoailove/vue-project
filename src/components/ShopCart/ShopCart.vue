<template>
  <div>
    <div class="shopcart">
      <div class="content">
        <div class="content-left" @click="toggole">
    ...
    <transition name="fade">
      <div class="list-mask" @click="toggole" v-show="listShow"></div>
    </transition>
  </div>
</template>
...
import {CLEAR_CART} from '../../store/mutations-types'
  export default {
    data () {
      return {
        isShow:false
